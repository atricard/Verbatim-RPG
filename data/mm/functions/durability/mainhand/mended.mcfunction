# Get current durability and reduce add 1 to that
execute store result score $durability v_temp run data get storage verbatim:temp root.SelectedItem.tag.verbatim.durability
scoreboard players add $durability v_temp 1
# Get max durability
