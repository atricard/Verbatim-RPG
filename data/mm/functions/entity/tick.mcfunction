...
execute as @s[type=firework_rocket,nbt={FireworksItem:{id:"minecraft:firework_rocket",Count:1b,tag:{placeForge:1b,CustomModelData:2019,Fireworks:{},display:{Name:'{"text":"Weapon Forge","italic":false}'}}}}] run function mm:forge/place
