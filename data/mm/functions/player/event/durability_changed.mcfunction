scoreboard players reset @s v_dur_changed
...
execute if data storage verbatim:temp root.SelectedItem.tag.verbatim.weapon run function mm:durability/mainhand/main