replaceitem entity @s weapon.mainhand minecraft:book{xPos_scroll:0,yPos_scroll:0,zPos_scroll:0,display:{Name:'[{"text":"Inscribed Ender Tome","color":"light_purple","italic":false},{"text":" [10 ❈]","color":"light_purple","italic":false}]'},HideFlags:1,Enchantments:[{id:"minecraft:protection",lvl:1s}]} 1
tag @s add get_pos
...
kill @e[type=item,nbt={Item:{id:"minecraft:book",Count:1b,tag:{display:{Name:'[{"text":"Blank Ender Tome","color":"light_purple","italic":false},{"text":" [10 ❈]","color":"light_purple","italic":false}]'}}}}]
