...
execute if score @s craftID matches 6 run replaceitem block ~ ~ ~ container.15 minecraft:leather_leggings{customDur:560,v_customArmor:1b,display:{Name:'{"text":"Adamantine Leggings","italic":false}',color:4879173},AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:6,Operation:0,UUID:[I;767373104,-1680848615,-1253208866,313672676],Slot:"legs"}]} 1
execute if score @s craftID matches 6 run scoreboard players operation @s craftCount *= #1 objd_consts

execute if score @s craftID matches 7 run replaceitem block ~ ~ ~ container.15 minecraft:leather_helmet{customDur:480,v_customArmor:1b,display:{Name:'{"text":"Adamantine Helmet","italic":false}',color:4879173},AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:3,Operation:0,UUID:[I;767373104,-1680848615,-1253208866,313672676],Slot:"head"}]} 1
execute if score @s craftID matches 7 run scoreboard players operation @s craftCount *= #1 objd_consts

execute if score @s craftID matches 8 run replaceitem block ~ ~ ~ container.15 minecraft:leather_boots{customDur:410,v_customArmor:1b,display:{Name:'{"text":"Adamantine Boots","italic":false}',color:4879173},AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:3,Operation:0,UUID:[I;767373104,-1680848615,-1253208866,313672676],Slot:"feet"}]} 1
