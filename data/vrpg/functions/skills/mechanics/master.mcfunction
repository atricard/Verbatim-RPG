...
execute as @s[advancements={vrpg:skills/trade/charisma=true}] run execute as @e[type=villager,distance=..6] run data modify entity @s Offers.Recipes[].priceMultiplier set value 0.5f
execute as @s[advancements={vrpg:skills/trade/charisma=true}] run execute as @e[type=villager,distance=7..9] run data modify entity @s Offers.Recipes[].priceMultiplier set value 0f
