execute as @s[tag=float_0_0] run setblock ~ ~-1 ~ minecraft:structure_block[mode=load]{name:"vrpg:float_0",posX:-3,posY:-2,posZ:-3,sizeX:20,sizeY:18,sizeZ:19,rotation:"NONE",mirror:"NONE",mode:"LOAD",ignoreEntities:0b} replace
execute as @s[tag=float_1_0] run setblock ~ ~-1 ~ minecraft:structure_block[mode=load]{name:"vrpg:float_1",posX:-3,posY:-2,posZ:-3,sizeX:20,sizeY:18,sizeZ:19,rotation:"NONE",mirror:"NONE",mode:"LOAD",ignoreEntities:0b} replace
execute as @s[tag=float_2_0] run setblock ~ ~-1 ~ minecraft:structure_block[mode=load]{name:"vrpg:float_2",posX:-3,posY:-2,posZ:-3,sizeX:20,sizeY:18,sizeZ:19,rotation:"NONE",mirror:"NONE",mode:"LOAD",ignoreEntities:0b} replace
...
execute as @s[tag=float_2_90] run setblock ~ ~-1 ~ minecraft:structure_block[mode=load]{name:"vrpg:float_2",posX:3,posY:-2,posZ:-3,sizeX:20,sizeY:18,sizeZ:19,rotation:"CLOCKWISE_90",mirror:"NONE",mode:"LOAD",ignoreEntities:0b} replace
...
execute as @s[tag=float_2_180] run setblock ~ ~-1 ~ minecraft:structure_block[mode=load]{name:"vrpg:float_2",posX:3,posY:-2,posZ:3,sizeX:20,sizeY:18,sizeZ:19,rotation:"CLOCKWISE_180",mirror:"NONE",mode:"LOAD",ignoreEntities:0b} replace
...
execute as @s[tag=float_2_270] run setblock ~ ~-1 ~ minecraft:structure_block[mode=load]{name:"vrpg:float_2",posX:-3,posY:-2,posZ:3,sizeX:20,sizeY:18,sizeZ:19,rotation:"CLOCKWISE_270",mirror:"NONE",mode:"LOAD",ignoreEntities:0b} replace
...
execute if block ~ ~-1 ~ minecraft:structure_block run setblock ~ ~-1 ~ minecraft:air
execute if block ~ ~-2 ~ minecraft:redstone_block run setblock ~ ~-2 ~ minecraft:air
