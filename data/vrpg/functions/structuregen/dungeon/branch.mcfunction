...
execute as @s[tag=center,tag=!exRoom] run function vrpg:structuregen/dungeon/possible/openall
...
execute if entity @e[type=area_effect_cloud,tag=center,tag=exRoom,scores={dungeonTaper=..24}] run function vrpg:structuregen/dungeon/openmaster
function vrpg:structuregen/dungeon/gatemaster
execute if entity @e[type=area_effect_cloud,tag=center,tag=exRoom,scores={dungeonTaper=25..}] run function vrpg:structuregen/dungeon/closemaster
