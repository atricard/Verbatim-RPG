...
#
execute at @e[type=item_frame,tag=v_ship_core] positioned ~-10 ~-10 ~-10 if entity @a[dx=21,dy=21,dz=21,x_rotation=-66..66,y_rotation=136..224,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'{"text":"Floatstone Wand","color":"yellow","italic":false}'},HideFlags:4,Unbreakable:1b,CustomModelData:110}}},scores={carrot=1..}] as @a[dx=21,dy=21,dz=21] at @s run teleport @s ~ ~ ~-1
execute at @e[type=item_frame,tag=v_ship_core] positioned ~-10 ~-10 ~-10 if entity @a[dx=21,dy=21,dz=21,x_rotation=-66..66,y_rotation=225..315,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'{"text":"Floatstone Wand","color":"yellow","italic":false}'},HideFlags:4,Unbreakable:1b,CustomModelData:110}}},scores={carrot=1..}] as @a[dx=21,dy=21,dz=21] at @s run teleport @s ~1 ~ ~
execute at @e[type=item_frame,tag=v_ship_core] positioned ~-10 ~-10 ~-10 if entity @a[dx=21,dy=21,dz=21,x_rotation=-66..66,y_rotation=316..44,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'{"text":"Floatstone Wand","color":"yellow","italic":false}'},HideFlags:4,Unbreakable:1b,CustomModelData:110}}},scores={carrot=1..}] as @a[dx=21,dy=21,dz=21] at @s run teleport @s ~ ~ ~1
execute at @e[type=item_frame,tag=v_ship_core] positioned ~-10 ~-10 ~-10 if entity @a[dx=21,dy=21,dz=21,x_rotation=-66..66,y_rotation=45..135,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'{"text":"Floatstone Wand","color":"yellow","italic":false}'},HideFlags:4,Unbreakable:1b,CustomModelData:110}}},scores={carrot=1..}] as @a[dx=21,dy=21,dz=21] at @s run teleport @s ~-1 ~ ~
