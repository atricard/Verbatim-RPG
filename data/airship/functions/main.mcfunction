...
execute as @e[type=item_frame,tag=v_ship_core] at @s unless block ~ ~ ~ smooth_stone run function airship:break
...
execute at @e[type=item_frame,tag=v_ship_core] positioned ~-5 ~-5 ~-5 if entity @a[dx=11,dy=11,dz=11,y_rotation=136..224,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'{"text":"Floatstone Totem","color":"yellow","italic":false}'},HideFlags:4,Unbreakable:1b,CustomModelData:110}}},scores={carrot=1..}] as @a[dx=11,dy=11,dz=11] at @s run teleport @s ~ ~ ~-1
execute at @e[type=item_frame,tag=v_ship_core] positioned ~-5 ~-5 ~-5 if entity @a[dx=11,dy=11,dz=11,y_rotation=225..315,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'{"text":"Floatstone Totem","color":"yellow","italic":false}'},HideFlags:4,Unbreakable:1b,CustomModelData:110}}},scores={carrot=1..}] as @a[dx=11,dy=11,dz=11] at @s run teleport @s ~1 ~ ~
execute at @e[type=item_frame,tag=v_ship_core] positioned ~-5 ~-5 ~-5 if entity @a[dx=11,dy=11,dz=11,y_rotation=316..44,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'{"text":"Floatstone Totem","color":"yellow","italic":false}'},HideFlags:4,Unbreakable:1b,CustomModelData:110}}},scores={carrot=1..}] as @a[dx=11,dy=11,dz=11] at @s run teleport @s ~ ~ ~1
execute at @e[type=item_frame,tag=v_ship_core] positioned ~-5 ~-5 ~-5 if entity @a[dx=11,dy=11,dz=11,y_rotation=45..135,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'{"text":"Floatstone Totem","color":"yellow","italic":false}'},HideFlags:4,Unbreakable:1b,CustomModelData:110}}},scores={carrot=1..}] as @a[dx=11,dy=11,dz=11] at @s run teleport @s ~-1 ~ ~
...
execute as @e[type=item_frame,tag=v_ship_core_fake,tag=new_block] at @s run summon minecraft:item_frame ~ ~ ~ {Tags:["v_ship_block","v_ship_core"],Facing:2b,Invulnerable:1b,Silentt:1b,Invisible:1b,Fixed:1b,Item:{id:"minecraft:barrier",Count:1b,tag:{CustomModelData:4000}}}
