execute positioned ~-10 ~-10 ~-10 if entity @e[dx=21,dy=21,dz=21,type=item_frame,tag=v_ship_core,tag=old_core] as @e[type=armor_stand,tag=v_ship_core_stand] at @s run function airship:break
