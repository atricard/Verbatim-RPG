summon minecraft:area_effect_cloud ~ ~ ~ {Duration:2147483647,Tags:["containRNG","spiderspawner"]}
summon minecraft:area_effect_cloud ~ ~ ~ {Duration:2147483647,Tags:["containRNG","zombiespawner"]}
