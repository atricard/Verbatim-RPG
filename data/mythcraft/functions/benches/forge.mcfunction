...
summon minecraft:armor_stand ~ ~1.25 ~ {NoGravity:1b,Tags:["marker"],CustomNameVisible:1b,Marker:true,DisabledSlots:4096,Invisible:1,NoGravity:1,CustomName:'{"text":"Orb Forge","color":"gold"}'}
